  ...
  return (
    <div className="slider-area position-relative">
      <span
        ...
        style={{
          backgroundImage: `url(${process.env.PUBLIC_URL + "/assets/img/icon-img/snow1.png"
            })`
        }}
      />
      <div
        ...
        style={{
          backgroundImage: `url(${process.env.PUBLIC_URL + sliderData.backgroundImage
            })`
        }}
      >
          ...
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
              <div className="slider-single-img-14">
                <img src={process.env.PUBLIC_URL + sliderData.image} alt="картинка" />
              </div>
            </div>
          </div>
        </div>
